...
print(sum([len(set("".join(["".join([letter for letter in person if all(letter in other_person for other_person in group)]) for person in group]))) for group in groups_of_people]))
